...
"""Verify that starting bikcoin with -h works as expected."""

from test_framework.test_framework import BikcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BikcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bikcoin with -h for help text")
        ...
        self.log.info("Start bikcoin with -version for version information")
        ...
        self.log.info("Start bikcoind with -fakearg to make sure it does not start")
