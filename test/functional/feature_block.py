...
class FullBlockTest(BikcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bikcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure bikcoind isn't accepting b28
        ...
        # bikcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bikcoin code has custom code which does so);
