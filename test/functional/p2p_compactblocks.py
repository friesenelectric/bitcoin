...
# TestP2PConn: A peer we use to send messages to bikcoind, and store responses.
...
class CompactBlocksTest(BikcoinTestFramework):
    ...
    # This test actually causes bikcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bikcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bikcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bikcoind will not send blocktxn responses for blocks whose height is
