...
* bikcoin.conf: contains configuration settings for bikcoind or bikcoin-qt
* bikcoind.pid: stores the process id of bikcoind while running
...
* debug.log: contains debug information and general logging generated by bikcoind or bikcoin-qt
