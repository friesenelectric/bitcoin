Bikcoin Core version 0.16.1 is now available from:

  <https://bikcoincore.org/bin/bikcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bikcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bikcoind processes are cleaned up when tests end (sdaftuar)
