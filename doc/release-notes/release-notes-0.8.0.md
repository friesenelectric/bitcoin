Bikcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bikcoin/files/Bikcoin/bikcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bikcoin
...
New/changed settings (command-line or bikcoin.conf file)
--------------------------------------------------------
