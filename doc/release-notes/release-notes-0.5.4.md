Bikcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bikcoin/files/Bikcoin/bikcoin-0.5.4/
...
http://gitorious.org/bikcoin/bikcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bikcoin-Qt notifications under Growl 1.3.
Increase required age of Bikcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBikcoin properly when installing Bikcoin-Qt over it. (Windows)
