Bikcoin Core version 0.13.2 is now available from:

  <https://bikcoin.org/bin/bikcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bikcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bikcoin-tx to create v2 transactions (btcdrak)
