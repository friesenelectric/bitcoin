Bikcoin Core version 0.10.4 is now available from:

  <https://bikcoin.org/bin/bikcoin-core-0.10.4/>
...
- #6953 `43c2789` Split bikcoin-tx into its own package
- #6953 `dfe0d4d` Include bikcoin-tx binary on Debian/Ubuntu
