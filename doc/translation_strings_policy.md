...
This document provides guidelines for internationalization of the Bikcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bikcoin_en.ts` remains unchanged.
