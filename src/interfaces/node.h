...
#ifndef BIKCOIN_INTERFACES_NODE_H
#define BIKCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bikcoin node (bikcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BIKCOIN_INTERFACES_NODE_H
