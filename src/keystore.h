...
#ifndef BIKCOIN_KEYSTORE_H
#define BIKCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bikcoin/bips/blob/master/bip-0013.mediawiki
