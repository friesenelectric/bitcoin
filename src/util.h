 ...
 */
#ifndef BIKCOIN_UTIL_H
#define BIKCOIN_UTIL_H
...
extern const char * const BIKCOIN_CONF_FILENAME;
extern const char * const BIKCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("bikcoin-%s", name);
