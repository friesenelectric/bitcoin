...
#ifndef BIKCOIN_QT_BIKCOINUNITS_H
#define BIKCOIN_QT_BIKCOINUNITS_H
...
/** Bikcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BikcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BikcoinUnits(QObject *parent);

    /** Bikcoin units.
      @note Source: https://en.bikcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef BikcoinUnits::Unit BikcoinUnit;

#endif // BIKCOIN_QT_BIKCOINUNITS_H
