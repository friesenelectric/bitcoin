    ...
    mapper(0)
{
    ...
    ui->bikcoinAtStartup->setToolTip(ui->bikcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bikcoinAtStartup->setText(ui->bikcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBikcoinConfButton->setToolTip(ui->openBikcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BikcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bikcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBikcoinConfButton_clicked()
{
