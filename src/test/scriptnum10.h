...
#ifndef BIKCOIN_TEST_SCRIPTNUM10_H
#define BIKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bikcoin Core 0.10.0, for cross-comparison.
 */
public:
