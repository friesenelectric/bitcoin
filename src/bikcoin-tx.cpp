...
static void SetupBikcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bikcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bikcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bikcoin transaction\n" +
            "or:     bikcoin-tx [options] -create [commands]   Create hex-encoded bikcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bikcoin transaction
